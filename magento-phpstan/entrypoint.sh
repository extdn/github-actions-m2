...
php $MAGENTO_ROOT/vendor/bin/phpstan analyse --level 1 --no-progress --error-format=raw --memory-limit=4G --configuration '$MAGENTO_ROOT/dev/tests/static/testsuite/Magento/Test/Php/_files/phpstan/phpstan.neon' $GITHUB_WORKSPACE